# Searchuse
A turn-based multiplayer strategy game where you search for and use various items-- two words, endless possibilities.
...
- Move, Search and Use
- Try to locate and attack the enemy before he does it to you
- Intel is key
